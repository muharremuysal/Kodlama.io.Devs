...
namespace WebAPI.Controllers
{
    ...
    public class ProgrammingLanguagesController : BaseController
    {
        ...
        [HttpDelete]
        public async Task<IActionResult> Delete([FromBody] DeleteByIdProgrammingLanguageCommand deleteByIdProgrammingLanguageCommand)
        {
            bool result = await Mediator.Send(deleteByIdProgrammingLanguageCommand);
